...
@property (nonatomic, strong) NSString * saveIpa;
...
-(OneDownloadItem * )initWithUrl:(NSString*)url andPlistUrl:(NSString*)plistUrl andGameName:(NSString*)gameName andGameIcon:(NSString*)icon andGameId:(NSString*)gameId andType:(NSString*)type;
